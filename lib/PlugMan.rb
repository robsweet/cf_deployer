...
=end
  ...
  class Plugin
    ...
    def PlugMan.call_plugins key, extension_point, *args
      PlugMan.extensions(key.to_sym, extension_point.to_sym).each { |plugin| plugin.send extension_point.to_sym, *args }
    end
    ...
    # Gets a hash of all the registered plugins except root
    def PlugMan.nonroot_plugins
      non_root = registered_plugins
      non_root.delete :root
      non_root
    end
